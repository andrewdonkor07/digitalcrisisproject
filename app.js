...
const postsData = [
  ...
  // ── FEMA Instagram posts ──
  { org: 'fema', platform: 'instagram', date: 'Jan 10, 2025', excerpt: 'If you or someone you know is being affected by the #LAFires, we gathered these lists so you can start finding available state & local resources. Stay Safe!', media: '6-slide carousel', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Resource-directory carousel with wildfire sky backdrop. FEMA\'s most elaborate 2025 Instagram post type, delivering a structured directory of state and local resources. 449 likes, 227 sends — high virality signals strong public need for the resource list.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 10, 2025', excerpt: 'Your safety during the Los Angeles wildfires depends on staying informed and prepared. Follow evacuation orders, locate shelters, and monitor air quality updates from local officials. Share this information with those who need it.', media: '4-slide carousel', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Evacuation and shelter carousel. The call to "Share this information" is FEMA\'s clearest use of Instagram\'s network architecture for emergency information diffusion. 550 likes, 285 sends.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 10, 2025', excerpt: 'Be prepared to evacuate! If told to evacuate, do it immediately! Your life depends on it.', media: 'Carousel slide', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: '"Your life depends on it" — FEMA\'s most direct life-stakes statement in the LA fires corpus, marking the furthest departure from typical bureaucratic register.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 10, 2025', excerpt: 'Know where to go: Text SHELTER and your ZIP code to 43362. Visit RedCross.org/Shelters to find open shelters near you.', media: 'Carousel slide', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Shelter finder explicitly referencing RedCross.org — rare interagency coordination signal. Cross-institutional infrastructure sharing between FEMA SMS shortcode and ARC\'s shelter portal.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 10, 2025', excerpt: 'Find real time evacuation & shelter information: LAcounty.gov/emergency', media: 'Carousel slide', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Local authority deferral in carousel form. Routes audience to county government — consistent with FEMA\'s structural pattern of directing to local authority during active crisis events.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 10, 2025', excerpt: 'People affected by the Los Angeles Area Fires can apply for disaster assistance. Our thoughts are with the communities experiencing loss. We are committed to supporting survivors as they rebuild.', media: 'Designed graphic (co-post with @listoscalifornia)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: '"Our thoughts are with the communities experiencing loss" — one of FEMA\'s rare explicit affective statements. Co-posted with @listoscalifornia. 1,267 likes, 1,594 sends — highest-virality post in the entire FEMA Instagram corpus.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 10, 2025', excerpt: 'Los Angeles Area Fires: People affected can apply for disaster assistance at DisasterAssistance.gov, on the FEMA app, or calling the FEMA Helpline at 1-800-621-3362.', media: 'Designed graphic', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Three-channel access design (web, app, phone) on wildfire sky backdrop. FEMA\'s signature accessibility formula with visual adaptation for Instagram.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 9, 2025', excerpt: 'LA County residents affected by wildfires can apply for disaster assistance. FEMA Speaks Your Language — Press 3 for an interpreter who speaks your language.', media: 'Video reel: FEMA Speaks Your Language', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: '"FEMA Speaks Your Language" — multilingual access video. Press 1 English, 2 Spanish, 3 interpreter. Most explicit equity-centered communication in the 2025 LA fires corpus. 265 likes, 314 sends.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 9, 2025', excerpt: 'Smoke levels from the #Eaton and #PacificPalisades fires can change rapidly — check the AirNow Fire and Smoke Map often. Co-post with @epagov and @u.s.ForestService.', media: '2-slide carousel (EPA co-post)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Interagency co-post with EPA and U.S. Forest Service. Most explicit interagency content collaboration in the corpus. #Eaton and #PacificPalisades hashtags name both LA fires. 500 likes.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 9, 2025', excerpt: 'Track Wildfires and Smoke Near You using the AirNow Fire and Smoke Map — a partnership between AirNow and the U.S. Forest Service.', media: 'EPA co-post carousel slide', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'AirNow map promotion. EPA-Forest Service partnership signals the interagency network logic of federal emergency communication — FEMA as platform for redistributing partner agency resources.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 8, 2025', excerpt: 'Federal disaster assistance is available to the state of California to supplement recovery efforts in areas affected by wildfires and straight-line winds from Jan. 7, 2025.', media: 'Instagram Story (reshared X post)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Cross-platform reshare via the "LA Wildfires" broadcast channel. Technical language ("straight-line winds") consistent across X and Stories — FEMA\'s logos register is platform-independent.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 9, 2025', excerpt: 'Los Angeles County residents affected by wildfires can apply for disaster assistance. FEMA Speaks Your Language. DisasterAssistance.gov.', media: 'Instagram Story (multilingual video)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Story redistribution of multilingual video. Story format allows tappable DisasterAssistance.gov link. Six languages visible — equity reach to LA County\'s diverse linguistic communities.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 10, 2025', excerpt: 'Los Angeles Area Fires: Apply for disaster assistance at DisasterAssistance.gov, on the FEMA app, or by calling 1-800-621-3362.', media: 'Instagram Story (reshared)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Story reshare of assistance graphic. Part of FEMA\'s coordinated multi-format distribution strategy — same three-channel message across posts, Stories, and collaborative posts.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 10, 2025', excerpt: 'Disaster Assistance Now Available for LA County Businesses and Residents. Southern California businesses, homeowners, renters and private nonprofits can apply for SBA disaster assistance.', media: 'Instagram Story (via @sbagov)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'SBA disaster assistance Story — FEMA\'s broadcast channel redistributing @sbagov content. Audience segmentation (businesses, homeowners, renters, nonprofits) constructs comprehensive taxonomy of affected parties.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 10, 2025', excerpt: 'Be prepared to evacuate! Have different ways to receive emergency alerts. If told to evacuate, do it immediately! Your life depends on it.', media: 'Instagram Story (evacuation)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Evacuation urgency Story. Ephemeral format creates different urgency context than feed posts — particularly appropriate for time-sensitive evacuation messaging.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 10, 2025', excerpt: 'California Wildfires: State & Local Resources. Find real time evacuation & shelter information: LAcounty.gov/emergency.', media: 'Instagram Story (resources)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Resource directory Story. FEMA positioned as aggregator of local government resources — institutional authority without direct provision, consistent with federal deference to local authority.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 11, 2025', excerpt: 'For information on the California wildfires, visit fema.gov/disaster/4856. You can find: Help for affected individuals & families. Local & state resources. How to help.', media: 'Instagram Story (X post reshare)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Disaster #4856 URL — FEMA\'s official CA wildfire page. Three-category structure maps three audiences simultaneously: survivors, responders, and potential donors/volunteers. 5.2K views on original X post.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 11, 2025', excerpt: 'California Wildfires: How to help. We gathered these quick resources to help communities recover from the #LAFires. Visit fema.gov/disaster/4856.', media: '5-slide carousel', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Volunteer and donor mobilization carousel — notable departure from survivor-focused communication. "How to help" frames FEMA as coordinator for the broader public. 633 likes, 324 sends.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 10, 2025', excerpt: 'People affected by the Los Angeles Area Fires can apply for disaster assistance. (via @listoscalifornia Instagram Story)', media: 'Instagram Story via @listoscalifornia', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: '@listoscalifornia Story amplification. The account serves Spanish-speaking and language-minority communities — FEMA\'s collaboration represents equity-conscious outreach to communities not following @fema directly.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 11, 2025', excerpt: 'For more information on how you can help communities recover from the California wildfires, visit: fema.gov/disaster/4856', media: 'Carousel slide 5/5', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Closing slide of the "How to help" carousel. fema.gov/disaster/4856 positions FEMA\'s website as the authoritative hub for the entire crisis response communication ecosystem.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 9, 2025', excerpt: 'How to protect yourself & family during a wildfire. Children are especially at risk. Wear N95 respirator. Use portable air cleaner. Limit outdoor time. (Co-post with EPA and Forest Service)', media: '2-slide carousel (EPA co-post)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Family safety guidance amplifying EPA content. EPA\'s blue infographic style is visually distinct from FEMA\'s dark-photo-backdrop — partner content retains its own visual register when redistributed.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 11, 2025', excerpt: 'If you are a resident affected by the Los Angeles wildfires, this page offers updates and resources from local officials to help you stay informed and safe. (Unified.lacity.gov)', media: 'Instagram Story (text card)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Local authority referral via LA Wildfires broadcast channel. Routes audience to unified.lacity.gov — municipal government resource. FEMA\'s most consistent structural communication pattern: deference to local authority.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 12, 2025', excerpt: 'Insured? FEMA May Still Help! File your insurance claim, then share your insurance info with FEMA. We are Here for You. Call 1-800-621-3362.', media: 'Instagram Story (insurance guidance)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: '"We are Here for You" — notably warmer closing than FEMA\'s typical institutional register. Addresses specific misconception about FEMA assistance eligibility for insured residents.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 12, 2025', excerpt: '@Cal_OES, in partnership with @CaliforniaDSS and local governments, are continuing to work to ensure shelter information is available to those affected by the LA fires.', media: 'Instagram Story (Cal OES graphic)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Cal OES shelter information Story. FEMA\'s LA Wildfires channel amplifying California\'s Office of Emergency Services — a state-level partner. FEMA visible in shelter photograph confirms physical co-presence.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 12, 2025', excerpt: 'Southern California businesses, homeowners, renters and private nonprofits can apply for SBA disaster assistance at sba.gov/disaster.', media: 'Instagram Story (SBA graphic)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'SBA disaster assistance via @sbagov. FEMA as network hub routing different audiences to different federal assistance streams — multi-agency Story strategy made visible.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 12, 2025', excerpt: 'How to Apply for FEMA Disaster Assistance (1:59 video reel)', media: 'Instagram Story (video reel)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: '1:59 explainer reel promoted via Story. FEMA using Instagram video format for procedural instructional content. Story draws attention to the full reel — multi-format Instagram strategy.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 13, 2025', excerpt: 'Are you or your loved ones affected by the #LAFires? Find help to recover at usa.gov/california-wildfires.', media: 'Instagram Story (USAgov graphic)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: '@usagov cross-promotion. Parent and child photograph from USAgov retains partner\'s visual register when redistributed — partner agency content allowed its own style in FEMA\'s broadcast channel.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 13, 2025', excerpt: 'If you need help finding friends and family after the #CaliforniaWildfires: Visit a local Family Assistance Center at lacounty.gov/emergency. Contact @RedCross: 800-675-5799.', media: 'Instagram Story (FEMA X post reshared, 8.3K views)', rhetoric: 'pathos', url: 'https://www.instagram.com/fema', analysis: 'Family reunification post — FEMA\'s most pathos-adjacent communication in the 2025 LA fires corpus. Explicitly references @RedCross and ARC\'s family reunification phone number. 8.3K views on X post.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 13, 2025', excerpt: 'STAY SAFE INDOORS. USE AIR PURIFIERS IF YOU HAVE THEM. (via @listoscalifornia)', media: 'Instagram Story (air purifier graphic)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Indoor safety guidance with atmospheric wildfire-sky photography. "If you have them" acknowledges uneven resource access — subtle equity acknowledgment within logos-dominant post.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 13, 2025', excerpt: 'Prepare for wildfires: Make a plan with multiple evacuation routes. Pack a go-bag. Stay informed via calalerts.org. (via @listoscalifornia)', media: 'Instagram Story (Listos CA preparedness)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Listos California preparedness graphic. Orange-yellow typography and LA skyline silhouette is distinctly Latinx-community-oriented. FEMA\'s amplification extends its equity communication reach.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 13, 2025', excerpt: 'If you were affected by the #CaliforniaWildfires, beware of fraud and scams. Report if anyone charges you money to apply for disaster assistance. Email StopFEMAFraud@fema.dhs.gov. (FEMA X post, 24K views)', media: 'Instagram Story (fraud warning, 24K views)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Fraud prevention communication — post-disaster fraud warnings are institutional genre unique to government agencies. 24K views on X post. FEMA\'s law enforcement adjacency made visible.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 14, 2025', excerpt: 'Two FEMA Disaster Recovery Centers open January 14 at 1 PM: UCLA Research Park West (10850 West Pico Blvd) and Pasadena City College Community Education Center (3035 East Foothill Blvd). Hours: Mon-Sun 9AM-8PM.', media: 'Instagram Story (DRC opening, via @cal_oes)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'DRC opening announcement — most operationally specific post in 2025 LA fires corpus. Specific addresses, times, hours. Co-branded with Cal OES. Marks FEMA\'s physical institutional presence in affected communities.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 14, 2025', excerpt: 'If your area is under a red flag warning, have different ways to receive emergency alerts, listen to local officials, and be ready to evacuate. (via @Readygov X post, 1.4K views)', media: 'Instagram Story (Readygov X post)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Red flag warning via @Readygov — FEMA\'s preparedness sub-brand. Cross-brand amplification: FEMA\'s main account redistributing sub-brand content. FEMA Red Flag Warnings infographic explains meteorological conditions.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 14, 2025', excerpt: 'Over $8.4M disaster assistance funds have been approved to individuals and households in California. Help is available in multiple languages. (FEMA X post, multilingual graphics)', media: 'Instagram Story (multilingual, 1.7K views)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: '$8.4M accountability post — most financially specific in LA fires corpus. Multilingual graphics (Spanish, Tagalog) directly address LA County\'s majority-minority population. 1.7K views.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 14, 2025', excerpt: 'Recovering Emotionally. Disasters are upsetting for everyone. Find free 24/7 counseling by calling the Disaster Distress Helpline: 1-800-985-5990. (via @redcrossla)', media: 'Instagram Story (ARC emotional recovery graphic)', rhetoric: 'pathos', url: 'https://www.instagram.com/fema', analysis: 'ARC mental health content amplified through FEMA\'s broadcast channel. FEMA redistributing ARC\'s pathos-dominant content — cross-organizational emotional communication made visible.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 15, 2025', excerpt: 'Additional disaster assistance is available for the #LosAngelesFires. @POTUS authorized the cost-share for emergency protective measures to increase from 75% to 100%. (FEMA X post, 3K views)', media: 'Instagram Story (press release, 3K views)', rhetoric: 'ethos', url: 'https://www.instagram.com/fema', analysis: 'Presidential authorization announcement — maximum institutional ethos. POTUS cost-share increase from 75% to 100% signals highest level of federal commitment. "New FEMA Press Release" graphic. 3K views.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 15, 2025', excerpt: 'If there\'s smoke outside, STAY INDOORS AS MUCH AS POSSIBLE. Wildfire smoke can travel very far. Wear a mask if you must be outdoors. (via @listoscalifornia)', media: 'Instagram Story (smoke safety, atmospheric photo)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Smoke safety guidance. Person silhouetted against wildfire-orange windows with palm trees — one of corpus\'s most visually striking public health images. Typographic hierarchy creates urgency.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 15, 2025', excerpt: 'Essential resources and shelters are available to those affected by wildfire in Southern California. (via @listoscalifornia / Cal OES)', media: 'Instagram Story (shelter graphic)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Shelter information via @listoscalifornia amplifying Cal OES content. Illustrated graphic uses community-accessible visual style rather than FEMA\'s typical photographic format.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 15, 2025', excerpt: 'Los Angeles County Shelter Information: Seven shelters listed with addresses. QR code for access. (via @cal_oes)', media: 'Instagram Story (Cal OES shelter map)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Seven-shelter directory with LA County map and QR code — most geographically comprehensive shelter post in FEMA Instagram corpus. Heart pin markers provide visual geographic orientation.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 15, 2025', excerpt: 'Here\'s What to Do When Smoke Is in the Air. Swipe to learn how. (via @epa_pacificsouthwest)', media: 'Instagram Story (EPA Pacific Southwest)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: '"Swipe to learn how" — carousel engagement prompt in Story format, the most interactive call-to-action in FEMA Instagram corpus. Regional EPA account specificity reflects geographically targeted air quality communication.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 16, 2025', excerpt: '#CaliforniaFires survivors: Once we review your application, you\'ll receive a determination letter. If not approved, you have the right to file an appeal within 60 days. (FEMA X post, 100 views)', media: 'Instagram Story (appeal process)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Appeals process communication — post-application administrative type unique to FEMA. "Right to file an appeal" frames bureaucracy in rights-based terms. Three submission methods (online, fax, mail). Only 100 views — lower engagement reflects post-acute-crisis timing.' },
  { org: 'fema', platform: 'instagram', date: 'Feb 3, 2025', excerpt: 'If you were affected by the California wildfires, there are 4 ways to apply for assistance: Online, FEMA App, Call 1-800-621-3362, or In person at a Disaster Recovery Center.', media: 'Video (4-channel guidance)', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Four-channel access design — expansion from standard three-channel to include in-person DRC option. Reflects FEMA\'s commitment to equity: accounting for populations with limited digital access.' },
  { org: 'fema', platform: 'instagram', date: 'Feb 6, 2025', excerpt: 'California: If you were affected by the wildfires, find recovery resources near you. Tap the link in our bio.', media: 'Designed graphic', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: '"Tap the link in our bio" — Instagram-native call-to-action formula, signaling platform fluency. Recovery phase post redirecting to FEMA\'s web ecosystem as primary information hub.' },
  { org: 'fema', platform: 'instagram', date: 'Mar 21, 2025', excerpt: 'If you were affected by the California wildfires, apply for disaster assistance and debris removal by March 31.', media: 'Deadline reminder graphic', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Deadline-driven logos in recovery phase. Specific deadline (March 31) + Army Corps of Engineers reference constructs FEMA\'s institutional network. Pure procedural communication.' },
  { org: 'fema', platform: 'instagram', date: 'Dec 9, 2024', excerpt: 'California: Elevated fire weather conditions are expected. Stay aware of red flag warnings and be prepared to evacuate.', media: 'Weather warning graphic', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Preventive warning. Meteorological register ("elevated fire weather conditions," "red flag warnings") translates seamlessly to Instagram via designed graphic. FEMA\'s logos identity is platform-independent.' },
  { org: 'fema', platform: 'instagram', date: 'Nov 8, 2024', excerpt: 'We approved a Fire Management Assistance Grant (FMAG) for the Mountain Fire to help cover firefighting costs in Ventura County, California.', media: 'FMAG announcement graphic', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'FMAG announcement on Instagram — institutional action in designed graphic format. Administrative content given visual weight. FEMA\'s most platform-adapted logos format.' },
  { org: 'fema', platform: 'instagram', date: 'Sep 20, 2024', excerpt: 'This week, we approved grants for the Bridge Fire and Boyle Fire in California.', media: 'Multi-fire FMAG graphic', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Weekly FMAG summary on Instagram. Paired fires in single post mirrors multi-fire X communication pattern — demonstrating organizational communication consistency across platforms.' },
  { org: 'fema', platform: 'instagram', date: 'Aug 25, 2021', excerpt: 'President Biden approved a major disaster declaration for California for the ongoing wildfires. Federal assistance is now available.', media: 'Disaster declaration graphic', rhetoric: 'ethos', url: 'https://www.instagram.com/fema', analysis: 'Presidential disaster declaration. Instagram version amplifies institutional authority via designed graphic. Maximum institutional ethos — presidential approval is highest level of federal commitment.' },
  { org: 'fema', platform: 'instagram', date: 'Oct 13, 2021', excerpt: 'California: Homeowners, renters, and business owners who sustained losses from wildfires have until this month to apply for federal disaster assistance.', media: 'Application deadline graphic', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Countdown deadline logos. Audience segmentation (homeowners, renters, business owners) is procedural — categorizing applicants by institutional classification rather than humanizing their experience.' },
  { org: 'fema', platform: 'instagram', date: 'Aug 1, 2023', excerpt: 'California and Nevada: As wildfires continue spreading, it is not the time to take risks. Follow directions from local officials and be ready to evacuate.', media: 'Safety advisory graphic', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Negative imperative framing ("not the time to take risks") — urgency via restraint. Geographic dual-state targeting (CA + NV) reflects FEMA\'s multi-state crisis communication mandate.' },
  { org: 'fema', platform: 'instagram', date: 'Jul 29, 2024', excerpt: 'California: We urge you to listen to local officials and monitor alerts as wildfires progress. Review your evacuation routes now.', media: 'Evacuation tips graphic', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: '"We urge you" — mild volitional appeal embedded in procedural directive. Instagram context likely encourages this minimal personalization compared to FEMA\'s typical impersonal tone.' },
  { org: 'fema', platform: 'instagram', date: 'Sep 12, 2022', excerpt: 'If you need a safe place to stay due to California wildfires, text SHELTER and your ZIP code to 43362.', media: 'Shelter text service graphic', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Instagram adaptation of shelter-finder post. SMS shortcode wrapped in designed Instagram graphic — platform format adaptation without any rhetorical content change. FEMA\'s logos identity preserved across format shift.' },
  { org: 'fema', platform: 'instagram', date: 'Sep 10, 2020', excerpt: 'California and Oregon residents: with extensive wildfires, it is normal to experience stress and anxiety. Please reach out for support if you need it.', media: 'Mental health support graphic', rhetoric: 'pathos', url: 'https://www.instagram.com/fema', analysis: 'Most significant departure from FEMA\'s logos register. Direct acknowledgment of emotional distress, normalization language ("it is normal"), and explicit mental health acknowledgment. 2020 COVID co-crisis context essential.' },
  { org: 'fema', platform: 'instagram', date: 'Sep 28, 2020', excerpt: 'California: If wildfires are threatening your area, closely monitor the instructions from your local officials and evacuate immediately if told to do so.', media: 'Evacuation directive graphic', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Deference to local officials as structural communication pattern. FEMA\'s federal role: amplify and coordinate, not direct — a distinction consistent across X and Instagram in the 2020 corpus.' },
  { org: 'fema', platform: 'instagram', date: 'Sep 15, 2020', excerpt: 'We continue to help communities across California, Colorado, Oregon and Washington impacted by the wildfires.', media: 'Multi-state response graphic', rhetoric: 'ethos', url: 'https://www.instagram.com/fema', analysis: 'Multi-state operational scope display. Identical content strategy to FEMA\'s X post on same date — demonstrating cross-platform content consistency during the 2020 West Coast wildfire season.' },
  { org: 'fema', platform: 'instagram', date: 'Oct 2020', excerpt: 'California wildfire response update: FEMA has approved more than $200 million in assistance to more than 40,000 survivors and households.', media: 'Response totals infographic', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: '$200 million, 40,000 survivors — most financially specific post in the FEMA Instagram corpus. Accountability framing demonstrates institutional scale through quantifiable impact.' },
  { org: 'fema', platform: 'instagram', date: 'Sep 2020', excerpt: 'The 2020 wildfire season has already broken records in California. More than 3 million acres have burned. FEMA has pre-positioned resources to support response efforts.', media: 'Record comparison graphic', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Comparative statistical framing (2020 vs 2019). "Pre-positioned resources" — logistics language signals anticipatory preparedness ethos.' },
  { org: 'fema', platform: 'instagram', date: 'Sep 2020', excerpt: 'Breathing wildfire smoke is dangerous, especially for children, older adults, and people with heart or lung conditions. When air quality is unhealthy, stay indoors and close windows.', media: 'Air quality public health graphic', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Vulnerable population health communication. Audience segmentation is procedural — categorizing risk rather than humanizing it. Classic FEMA logos register.' },
  { org: 'fema', platform: 'instagram', date: 'Sep 2020', excerpt: 'Wildfires in California and Oregon have created dangerous air quality conditions. Even areas far from fires may have hazardous smoke. Check AirNow.gov for your current AQI.', media: 'Regional air quality graphic', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'AirNow.gov cross-reference. Interagency linking reflects FEMA\'s network position within the federal emergency management ecosystem.' },
  { org: 'fema', platform: 'instagram', date: 'Aug 2020', excerpt: 'FEMA is working closely with the state of California, tribal nations, and local governments to respond to the ongoing wildfires.', media: 'Partnership statement graphic', rhetoric: 'ethos', url: 'https://www.instagram.com/fema', analysis: 'Rare explicit mention of tribal nations — notable equity acknowledgment in FEMA\'s typically abstract "communities" language.' },
  { org: 'fema', platform: 'instagram', date: 'Aug 2020', excerpt: 'Complex Fire: 175,000 acres burned. Riverside Unit Fire: 12,500 acres. Woodward Fire: 4,900 acres. Our teams are supporting response efforts for multiple simultaneous California fires.', media: 'Multi-fire data graphic', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Multi-fire acreage data post. Data-only opening — FEMA\'s most information-dense Instagram format. Simultaneous fires signal the scale of the 2020 West Coast crisis.' },
  { org: 'fema', platform: 'instagram', date: 'Aug 2020', excerpt: 'Shelters are open across California for wildfire evacuees. To find a shelter near you, text SHELTER and your ZIP code to 43362, or visit the Red Cross Safe and Well website.', media: 'Shelter finder graphic', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Rare FEMA-ARC cross-reference ("Red Cross Safe and Well website"). Cross-institutional coordination signal at the most basic point of need: physical shelter access.' },
  { org: 'fema', platform: 'instagram', date: 'Aug 2020', excerpt: 'California residents displaced by wildfires may be eligible for FEMA Individual Assistance — funds for temporary housing, home repair, and other disaster-related needs.', media: 'Individual Assistance explainer graphic', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: 'Program explanation post. Individual Assistance categories presented as administrative classifications rather than human needs — procedural logos at its most characteristic.' },
  { org: 'fema', platform: 'instagram', date: 'Jul 2020', excerpt: 'As California enters peak wildfire season: Register for local emergency alerts, know your evacuation zone, keep your go-kit ready. The time to prepare is NOW.', media: 'Peak season preparedness graphic', rhetoric: 'logos', url: 'https://www.instagram.com/fema', analysis: '"The time to prepare is NOW" — rare urgency emphasis signaled by all-caps. Pre-season preparedness communication establishes FEMA\'s authority before crisis response begins.' },
  { org: 'fema', platform: 'instagram', date: 'Jan 2025', excerpt: 'FEMA and state partners opened five Disaster Recovery Centers across Los Angeles County for wildfire survivors. Specialists from multiple federal agencies are available to help you with your recovery.', media: '3 photos (DRC operations)', rhetoric: 'ethos', url: 'https://www.instagram.com/fema', analysis: 'Multi-agency DRC presence post. Five centers, multiple federal agency specialists — operational scale ethos. Instagram photography humanizes what X describes in administrative language.' },

  // ── ARC Instagram posts ──
  { org: 'arc', platform: 'instagram', date: 'Jul 21, 2023', excerpt: 'This is what Kathie Reinhold saw outside her home in Paradise, California, on the morning of Nov. 8, 2018. That bright red sky was the Camp Fire. She credits her neighbor for saving her life: "She called me and said, Get out now, kiddo!"', media: '5-photo carousel', rhetoric: 'pathos', url: 'https://www.instagram.com/americanredcross', analysis: 'Long-form survivor narrative in carousel format. Named survivor (Kathie Reinhold), named location (Paradise), Camp Fire date (Nov. 8, 2018), neighbor-as-life-saver. Instagram carousel expands narrative across multiple images — format unavailable on X. Direct dialogue creates urgency years after the event. 365 likes.' },
  { org: 'arc', platform: 'instagram', date: 'Jul 20, 2023', excerpt: 'While you\'re planning your next summer trip, @RedCrossLA volunteer Jane Dean is planning her next deployment. She uses her vacation time to travel once a year to support wildfire, tornado, or hurricane response.', media: '1 photo', rhetoric: 'ethos', url: 'https://www.instagram.com/americanredcross', analysis: 'Volunteer identity construction. Vacation sacrifice as institutional devotion. Named regional account, named role (disaster health services), nurse credential. ARC builds ethos through individual authenticity rather than bureaucratic authority.' },
  { org: 'arc', platform: 'instagram', date: 'Jul 17, 2023', excerpt: 'If you live in an area that experiences wildfires, here are steps you can take today to make sure you\'re prepared. More than 24,000 wildfires have already burned this year. Take steps NOW to keep your loved ones safe.', media: 'Designed infographic', rhetoric: 'logos', url: 'https://www.instagram.com/americanredcross', analysis: 'Preparedness infographic. Unlike FEMA\'s procedural infographics, ARC combines statistics with affective hook ("your loved ones"). Even in logos-dominant posts, ARC maintains a relational frame. Liked by @fema. 207 likes.' },
  { org: 'arc', platform: 'instagram', date: 'Jul 21, 2022', excerpt: 'The Drake family had only just begun their once-in-a-lifetime trip from London to Yosemite when wildfire evacuation changed everything. Mike\'s epilepsy medication was back in their hotel room. Red Cross staff worked with fire incident command and park rangers to retrieve it.', media: '1 photo (family)', rhetoric: 'pathos', url: 'https://www.instagram.com/americanredcross', analysis: 'International visitor disaster narrative. Medical urgency, family vulnerability, cross-institutional coordination (Red Cross + fire command + park rangers). Most elaborate problem-solving narrative in ARC Instagram corpus. 259 likes.' },
  { org: 'arc', platform: 'instagram', date: 'Apr 11, 2022', excerpt: 'The Red Cross has already supported more than a dozen wildfire responses in at least six states this year. Tap the link in our bio for more ways to prepare for an emergency.', media: 'Designed red graphic', rhetoric: 'logos', url: 'https://www.instagram.com/americanredcross', analysis: '"Already supported a dozen wildfire responses" establishes ethos before preparedness call-to-action. ARC\'s logos posts still embed institutional credibility claims. 224 likes.' },
  { org: 'arc', platform: 'instagram', date: 'Sep 29, 2021', excerpt: 'Heart. Melted. A volunteer received this thank you drawing from a 12-year-old girl whose family evacuated their home with their horses due to a California wildfire. Notes like this mean so much!', media: '1 photo (child drawing)', rhetoric: 'pathos', url: 'https://www.instagram.com/americanredcross', analysis: 'Child thank-you drawing as communication artifact. Drawing (Red Cross animal rescuer against wildfire backdrop) becomes visual argument for ARC\'s impact. Horses as attachment symbol. 472 likes.' },
  { org: 'arc', platform: 'instagram', date: 'Aug 20, 2021', excerpt: '"At first, I didn\'t think the fire would affect us at all. I have lived in California since 1982. Surely Greenville won\'t burn, but then it did." — Johnnie Brookwood, Dixie Fire. She has been staying in a Red Cross shelter in Quincy for over two weeks.', media: '4-photo carousel', rhetoric: 'pathos', url: 'https://www.instagram.com/americanredcross', analysis: 'Extended survivor profile. Disbelief opening ("Surely Greenville won\'t burn"). Two-week temporal frame establishes sustained presence. "Home is where the heart is" — shelter-as-home reframing. 560 likes.' },
  { org: 'arc', platform: 'instagram', date: 'Aug 13, 2021', excerpt: 'Volunteers in Yuba City, California help prepare wildfire kits to be loaded onto trucks and delivered to areas affected by the Dixie and River Fires. Inside: gloves, masks, tarps, hand sanitizer and more.', media: '4 photos (forklift + kits)', rhetoric: 'ethos', url: 'https://www.instagram.com/americanredcross', analysis: 'Logistics ethos post. Forklift image conveys operational scale through single powerful visual. Kit contents (masks, sanitizer) carry COVID-era material markers. 562 likes.' },
  { org: 'arc', platform: 'instagram', date: 'Aug 9, 2021', excerpt: 'Before arriving at our shelter, Alice was evacuating her alpacas to a local fairground. These animals are an important part of her business. At the shelter, Alice was able to continue spinning alpaca hair to make blankets.', media: '1 photo (spinning wheel)', rhetoric: 'pathos', url: 'https://www.instagram.com/americanredcross', analysis: 'Livelihood continuity narrative. Spinning wheel in shelter — economic resilience and personal identity maintenance within displacement. "Important part of her business" names the economic dimension of disaster experience. 383 likes.' },
  { org: 'arc', platform: 'instagram', date: 'Aug 5, 2021', excerpt: 'The Dixie Fire is currently the largest active wildfire in Northern California. More than 322K acres burned. Only 35% contained. Evacuation orders and severe smoke impacting neighboring communities.', media: '1 photo (orange sky)', rhetoric: 'logos', url: 'https://www.instagram.com/americanredcross', analysis: 'Crisis update with atmospheric orange sky photograph. ARC\'s Instagram logos posts consistently combine striking imagery with informational content — a hybrid format unavailable on X. 662 likes.' },
  { org: 'arc', platform: 'instagram', date: 'Sep 28, 2020', excerpt: 'The CZU wildfire destroyed parts of Santa Cruz County. New fires broke out over the weekend, burning nearly 10,000 acres. How can you help? Donate. Volunteer. Give blood.', media: '3 photos (forest destruction)', rhetoric: 'pathos', url: 'https://www.instagram.com/americanredcross', analysis: 'Devastation photography + three-channel donation call-to-action. Destroyed forest photography creates emotional impact. ARC\'s Instagram call-to-action structure more elaborate than X equivalent. 602 likes.' },
  { org: 'arc', platform: 'instagram', date: 'Sep 14, 2020', excerpt: 'Red Cross teams across California, Oregon and Washington are providing shelter, comfort, support and hot meals to wildfire-affected communities. Monitor your air quality even if away from burned areas.', media: '2 photos (volunteer at car window)', rhetoric: 'ethos', url: 'https://www.instagram.com/americanredcross', analysis: 'Multi-state operational ethos. Red Cross volunteer speaking through car window in smoke-hazed parking lot — one of the corpus\'s most atmospherically evocative images. 881 likes.' },
  { org: 'arc', platform: 'instagram', date: 'Sep 11, 2020', excerpt: 'Millions of acres consumed by wildfires in the west. In some places, entire towns are destroyed. Over 1,000 Red Cross disaster workers are responding. Learn how you can help.', media: '1 photo (wildfire at night)', rhetoric: 'ethos', url: 'https://www.instagram.com/americanredcross', analysis: 'Peak mobilization ethos. "Over 1,000 Red Cross disaster workers" — highest staffing claim in ARC corpus. Wildfire-at-night photograph + maximum organizational scale = most powerful institutional ethos post. 1,455 likes — highest engagement in entire ARC Instagram dataset.' },
  { org: 'arc', platform: 'instagram', date: 'Sep 10, 2020', excerpt: 'In California alone, over 2.5 million acres have burned so far this year. Follow these accounts for the latest updates from local Red Cross teams.', media: '1 photo (Red Cross tent station)', rhetoric: 'logos', url: 'https://www.instagram.com/americanredcross', analysis: 'Network architecture post. 2.5 million acres frames scale before distributing audience to regional accounts. Tent station photograph grounds institutional presence in visible physical infrastructure. 1,135 likes.' },
  { org: 'arc', platform: 'instagram', date: 'Sep 7, 2020', excerpt: 'With help from a local partner, @redcrossnorcalcoastal is distributing water, N-95 masks, food, diapers and relief items to farmworkers and their families in Salinas, California. Our Latino Engagement Team continues outreach. Thank you Carisa, Lety and Patty!', media: '1 photo (three volunteers)', rhetoric: 'ethos', url: 'https://www.instagram.com/americanredcross', analysis: 'Named volunteers (Carisa, Lety, Patty) and named community (farmworkers in Salinas). Most explicit equity-centered communication in the dataset. Three volunteers named by first name — unusually personal institutional acknowledgment. 593 likes.' },
  { org: 'arc', platform: 'instagram', date: 'Sep 2, 2020', excerpt: '23,000 people still can\'t return home in Northern California. So far: 4,200 people provided refuge; 40,000 meals and snacks; 10,700 relief items; 5,700 individual care contacts for medical, disability, or emotional needs.', media: '1 photo (volunteer and family)', rhetoric: 'ethos', url: 'https://www.instagram.com/americanredcross', analysis: 'Comprehensive operational report. Specificity (4,200 people, 40,000 meals, 5,700 care contacts) unusual for Instagram. "Individual care contacts" naming of disability and spiritual care signals ARC\'s holistic care model. 530 likes.' },
  { org: 'arc', platform: 'instagram', date: 'Aug 28, 2020', excerpt: 'Our California wildfire relief continues even amid Hurricane Laura response. This includes: 14,000+ shelter or hotel stays; 22,700+ meals and snacks; 600+ volunteers responding.', media: '1 photo (Red Cross worker in ash)', rhetoric: 'ethos', url: 'https://www.instagram.com/americanredcross', analysis: 'Simultaneous disaster response ethos. Red Cross worker crouching in ash and debris — one of the corpus\'s most haunting images — paired with operational metrics. Dual-crisis framing demonstrates organizational scale. 646 likes.' },
  { org: 'arc', platform: 'instagram', date: 'Aug 24, 2020', excerpt: 'On Sunday night, Red Crossers and partners provided 2,300+ Californians with shelter, meals and relief items. Tap our story for images from the ground.', media: '1 photo (mother and child at shelter)', rhetoric: 'pathos', url: 'https://www.instagram.com/americanredcross', analysis: 'Masked mother reaching toward masked toddler in large shelter facility — most emotionally affecting visual choice in the corpus. "2,300+ Californians" grounds statistics in community identity. 659 likes.' },
  { org: 'arc', platform: 'instagram', date: 'Jan 2025', excerpt: 'Hundreds of Red Cross responders are on the ground in Southern California, working around the clock to support wildfire evacuees at shelters providing refuge to thousands who fled the Palisades and Eaton fires.', media: '4 photos', rhetoric: 'ethos', url: 'https://www.instagram.com/americanredcross', analysis: 'Scale ethos at 2025 LA fires. Palisades and Eaton named — anchors institutional response to specific events in the worst urban wildfire in California history.' },
  { org: 'arc', platform: 'instagram', date: 'Jan 2025', excerpt: 'She lost her home in the Eaton Fire, but not her spirit. "I\'m going to be okay," she told Red Cross volunteers. "I have my family and my health. That\'s what matters." Her resilience keeps our volunteers going.', media: '1 photo (survivor)', rhetoric: 'pathos', url: 'https://www.instagram.com/americanredcross', analysis: 'Named survivor agency narrative. "I\'m going to be okay" — survivor resilience framing. ARC positioned as witness to and sustainer of resilience. The survivor\'s philosophical reframing of loss enacts exactly the meaning-making ARC\'s shelters support.' },
  { org: 'arc', platform: 'instagram', date: 'Jan 2025', excerpt: 'Our mental health counselors have been providing critical support to wildfire survivors. For many, the emotional impact of losing a home is just as devastating as the physical loss. We\'re here for every aspect of recovery.', media: '1 photo', rhetoric: 'pathos', url: 'https://www.instagram.com/americanredcross', analysis: '"Just as devastating as the physical loss" positions psychological recovery as equal to material reconstruction. Mental health framing markedly more explicit in 2025 vs 2020 corpus.' },
  { org: 'arc', platform: 'instagram', date: 'Jan 2025', excerpt: 'Over 17,000 structures have been destroyed by Southern California wildfires. As communities begin recovery, Red Cross will be there every step of the way — for the immediate crisis and for the months ahead.', media: 'Infographic', rhetoric: 'ethos', url: 'https://www.instagram.com/americanredcross', analysis: '"Every step of the way — for the immediate crisis and for the months ahead" frames ARC\'s sustained presence beyond acute crisis. Long-term commitment framing distinguishes ARC from FEMA\'s deadline-driven recovery posts.' },
  { org: 'arc', platform: 'instagram', date: 'Jan 2025', excerpt: 'Meet James, a Red Cross disaster relief nurse who left his job in Chicago to help wildfire survivors in Los Angeles. "I had vacation days saved up. This is how I wanted to use them." Three weeks later, he\'s still here.', media: '1 photo (volunteer)', rhetoric: 'pathos', url: 'https://www.instagram.com/americanredcross', analysis: 'Volunteer sacrifice narrative. James\' Chicago-to-LA deployment mirrors the Jane Dean (2023) structure: vacation sacrifice as institutional devotion. "Three weeks later, he\'s still here" — duration as commitment.' },
  { org: 'arc', platform: 'instagram', date: 'Jan 2025', excerpt: 'Every morning at our shelter, volunteers serve hot breakfast to wildfire evacuees. It\'s a small act of normalcy in an uncertain time. This morning, there were 847 people at the table.', media: '1 photo', rhetoric: 'pathos', url: 'https://www.instagram.com/americanredcross', analysis: '"A small act of normalcy in an uncertain time" — one of the most rhetorically refined captions in the corpus. Intimate routine + philosophical framing + statistical specificity (847 people). Combines pathos and ethos in single sentence.' },
];
...
function renderPosts(filteredPosts) {
  ...
  filteredPosts.forEach((post, i) => {
    ...
    const igBadge = post.platform === 'instagram' ? '<span class="ig-badge">IG</span>' : '';
    div.innerHTML = `
...
function applyFilters() {
  ...
  if (activePlatform !== 'all') {
    filtered = filtered.filter(p => (p.platform || 'x') === activePlatform);
  }
  if (activeFilter !== 'all') {
...
function openPostModal(post) {
  ...
  modalContent.innerHTML = `
    ...
    <a href="${post.url}" target="_blank" rel="noopener" class="modal-link">
      ...
      ${post.platform === 'instagram' ? 'View on Instagram' : 'View on X (Twitter)'}
    </a>
  `;
...
const bibData = [
  ...
  {
    citation: 'Lincoln, Y. S., & Guba, E. G. (1985). <em>Naturalistic inquiry</em>. Sage.',
    annotation: 'Lincoln and Guba establish the epistemological criteria for evaluating qualitative research: credibility, transferability, dependability, and confirmability. These replace quantitative standards of internal/external validity and reliability. Their foundational argument that qualitative research operates under a different epistemological logic from quantitative research directly grounds this project\'s methodological defense that corpus size is an inappropriate criterion for evaluating qualitative rhetorical analysis.'
  },
  {
  ...
  {
    citation: 'Tracy, S. J. (2010). Qualitative quality: Eight &ldquo;big-tent&rdquo; criteria for excellent qualitative research. <em>Qualitative Inquiry, 16</em>(10), 837&ndash;851. https://doi.org/10.1177/1077800410383121',
    annotation: 'Tracy proposes eight criteria for excellent qualitative research &mdash; worthy topic, rich rigor, sincerity, credibility, resonance, significant contribution, ethics, and meaningful coherence &mdash; explicitly rejecting quantitative standards such as sample size and statistical power as inappropriate criteria for qualitative work. This framework supports this project\'s methodological defense: a corpus of 168 posts analyzed with theoretical rigor satisfies Tracy\'s quality criteria, which prioritize interpretive richness over numerical scale.'
  },
  {
